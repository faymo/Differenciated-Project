    ...
    <>
      ...
      <div id="disadvantages" className="relative text-white flex flex-col place-items-center p-10 pt-14 bg-black">
        ...
        <div class="flex place-items-center">
          ...
          <img class="h-[25rem] w-[40rem] mx-5 bg-white" src={'/images/graph2.png'} alt=""/>
        </div>
        ...
        <div class="flex place-items-center">
          <img class="h-[25rem] w-[40rem] mx-5" src={'/images/up.jpeg'} alt=""/>
          <p class="text-xl text-right">
        ...
        <div class="flex place-items-center">
          ...
          <img class="h-[25rem] w-[40rem] mx-5 bg-white" src={'/images/hp.jpeg'} alt=""/>
        </div>
        ...
        <div class="flex place-items-center">
          ...
          <img class="h-[24rem] w-[40rem] mt-4 mx-5 bg-white" src={'/images/lack.jpeg'} alt=""/>
        </div>
        ...
        <div class="flex place-items-center">
          <img class="h-[25rem] w-[40rem] mx-5" src={'/images/export.jpeg'} alt=""/>
          <p class="text-xl text-right">
